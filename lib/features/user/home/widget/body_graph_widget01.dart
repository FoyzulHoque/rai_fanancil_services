...
class BodyGraphWidget01 extends StatelessWidget {
  const BodyGraphWidget01({
    ...
    this.fillOpacity =
        0.4, // লাইনের নিচে ফিলের স্বচ্ছতা (0.0 = পুরোপুরি স্বচ্ছ, 1.0 = পুরোপুরি অস্বচ্ছ)
  });
  ...
  Widget build(BuildContext context) {
    ...
    final double maxY =
        spots.map((spot) => spot.y).reduce((a, b) => a > b ? a : b) + 500;
                ...
                LineChartData(
                  ...
                  gridData: FlGridData(
                    ...
                    horizontalInterval: (maxY / 4)
                        .roundToDouble(), // ৪টা সমান গ্রিড লাইন
                  ...
                  maxX: (monthlyData.length - 1)
                      .toDouble(), // X-axis শেষ (ডাটার সংখ্যা অনুযায়ী)
